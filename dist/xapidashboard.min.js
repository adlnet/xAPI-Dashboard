/*! xAPI-Dashboard v0.1.0-alpha | Built on 04-24-2014 */
...
})},b.average=function(b,c){var d=a.Collection.genRange(c.range.start,c.range.end,c.range.increment);return b.groupByRange(c.groupField||c.xField,d,function(a){return a.count()/c.range.unit})},a.XAPIDashboard=b}(window.ADL=window.ADL||{}),function(a){function b(a,b,c){"string"==typeof b?(this.container=b,this.opts=c||{}):this.opts=b||{},this.statements=a}function c(c,d,e){b.call(this,c,d,e),this.opts.chartType="discreteBarChart",this.opts.aggregate=this.opts.aggregate?this.opts.aggregate:a.XAPIDashboard.count,this.opts.nvd3Opts=this.opts.nvd3Opts?this.opts.nvd3Opts:{x:function(a){return a.in},y:function(a){return a.out},staggerLabels:!0,transitionDuration:250}}function d(c,d,e){b.call(this,c,d,e),this.opts.chartType="lineChart",this.opts.aggregate=this.opts.aggregate?this.opts.aggregate:a.XAPIDashboard.accumulate,this.opts.nvd3Opts=this.opts.nvd3Opts?this.opts.nvd3Opts:{x:function(a){return a.in},y:function(a){return a.out},showXAxis:!0,showYAxis:!0,transitionDuration:250}}b.prototype.draw=function(a){var b=this.statements,c=this.opts,a=a?a:this.container;return c.aggregate&&c.chartType&&a?(c.pre&&(b=c.pre(b)),b=c.aggregate(b,c),c.post&&(b=c.post(b)),void nv.addGraph(function(){var d=nv.models[c.chartType]().options(c.nvd3Opts);return c.customize&&c.customize(d),d3.select(a).datum([{values:b.contents}]).call(d),nv.utils.windowResize(d.update),d})):void console.error("Must specify aggregate function, chartType, and container before drawing chart",c)},b.prototype.addOptions=function(a){for(var b in a)a.hasOwnProperty(b)&&(this.opts[b]=a[b])},c.prototype=new b,c.prototype.constructor=c,d.prototype=new b,d.prototype.constructor=d,a.Chart=b,a.BarChart=c,a.LineChart=d}(window.ADL=window.ADL||{});